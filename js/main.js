(function ($) {
    ...
    $(document).ready(function () {
        ...
        // ******************************* SLAJDER SA SLIKAMA ***************************// 
        // Selektujte sve slike sa klasom "thumbnail-image"
        var thumbnailImages = document.querySelectorAll('.thumbnail-image');

        // Selektujte elemente za prikazivanje preko celog ekrana
        ...
        // Dodajte događaj za klik na svaku sliku
        thumbnailImages.forEach(function(thumbnail) {
        thumbnail.addEventListener('click', function() {
            // Postavite izvor slike i prikažite overlay
        ...
        // Dodajte događaj za klik na dugme za zatvaranje
        closeButton.addEventListener('click', function() {
        // Sakrijte overlay
        overlay.style.display = 'none';
        });

        // Dodajte sledeći JavaScript kod za listanje slika
        var currentIndex = 0;
        var thumbnails = Array.from(document.querySelectorAll('.thumbnail-image'));
        var prevButton = document.getElementById('prev-button');
        var nextButton = document.getElementById('next-button');

        // Dodajte događaje za klik na prethodno i sledeće dugme
        ...
        // Dodajte događaje za klik na svaku sliku
        ...
        $('.portfolio-wrapper').each(function () {
            ...
            // Postavljanje početno aktivnog filtera
            var portfolioFilter = _this.find('.portfolio-filter');
            portfolioFilter.find('.one').addClass('active');
        });
...
$(document).ready( function() {
    ...
    function setPagination() {
        ...
        var CreatePagers = function() {
            ...
            var $page_prev_btn=$('<a type="button" class="btn btn-primary previous_btn"><<</a>');

                          
                          
            var $page_next_btn=$('<a type="button" class="btn btn-primary next_btn">>></a>');
